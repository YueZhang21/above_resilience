...
def forwardFiltering_interv(M,Disturb,inflation=5):
    
    # Disturb -> an array with the same length of Y. True if disturbance happened, False otherwise
    # Inflation -> a multiplicative factor increase the uncertainty of theta, i.e., C, when disturbance occurs
